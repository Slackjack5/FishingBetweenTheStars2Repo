Shader "Hidden/Locked/.poiyomi/• Poiyomi Toon •/FishingTarget-FishingTarget"
{
    Properties
    {
...
#define PROP_ALPHAPREMULTIPLY 1
...
#define PROP_OUTLINELIT 0
#define PROP_LINEWIDTH 1
#define PROP_OUTLINEEMISSION 1
